            ...
            <div className={"container secondary-container"} id={"learn-more"}>
                <div className={"section learn-more-section"}>
                    ...
                    <p>A student's goal in going to college is to learn material<span>&#8212;</span>not to learn
                        material the first time that student hears it. Unfortunately, even in top-rated universities,
                        this is often the expectation. Even if a student takes extremely good notes, if the they don't
                        remember and understand what the professor said, the notes won't make any sense. To add to the
                        problem, many classes don't require textbooks, and if they do, they're nearly impossible to read
                        efficiently.
                    </p>
                    <p style={{marginBottom: "40px"}}>But there's another problem: What if a student wasn't able to go
                        ...
                        not capable of providing this as a real option. For them, it's either address their personal
                        well being or go to class.
                    </p>
                    ...
                    <p style={{marginBottom: "40px"}}>Some professors attempt to address the problem by recording their
                        ...
                        each
                        recording on the professor. Many professors avoid this burden, choosing to not record their
                        lectures
                        entirely.
                    </p>
                    <h2>We offer the solution.</h2>
                    <p style={{marginBottom: "40px"}}>Pupil is a system that provides professors with automatic lecture
                        recordings based on their class schedule and students with online, convenient access to all of
                        their class lectures.
                    </p>
